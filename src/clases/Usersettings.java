...
public class Usersettings extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombreUsuario = ShowUser.getText();
        String password = ShowPass.getText();
        PreparedStatement pst= (PreparedStatement)cn.prepareStatement("UPDATE usuarios SET IDUSER= ?, Nombreusuario=?, Password=? WHERE IDUSER ='"+ShowID.getText()+"'"); 
        pst.setString(1,id);
        ...
        int rowsAffected = pst.executeUpdate();  
            ...
            if (rowsAffected > 0) {
                ...
                this.setConfiguracion(nombreUsuario);
            } else {
